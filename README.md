...
<div align="center">
  ...
  <!-- Snake animation - Generated dynamically by GitHub Actions -->
  ...
  <!-- Note: The snake animation will be generated by GitHub Actions workflow -->
  <!-- After pushing to GitHub, go to Actions tab and run the workflow manually -->
  <!-- Or wait for it to run automatically (daily at midnight UTC) -->
